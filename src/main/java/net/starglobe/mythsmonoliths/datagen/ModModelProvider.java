...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        BlockStateModelGenerator.BlockTexturePool smoothNetherBrickPool = blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.SMOOTH_NETHER_BRICKS);
        smoothNetherBrickPool.slab(ModBlocks.SMOOTH_NETHER_BRICK_SLAB);
        smoothNetherBrickPool.stairs(ModBlocks.SMOOTH_NETHER_BRICK_STAIRS);
        smoothNetherBrickPool.wall(ModBlocks.SMOOTH_NETHER_BRICK_WALL);
        BlockStateModelGenerator.BlockTexturePool smoothRedNetherBrickPool = blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.SMOOTH_RED_NETHER_BRICKS);
        smoothRedNetherBrickPool.slab(ModBlocks.SMOOTH_RED_NETHER_BRICK_SLAB);
        smoothRedNetherBrickPool.stairs(ModBlocks.SMOOTH_RED_NETHER_BRICK_STAIRS);
        smoothRedNetherBrickPool.wall(ModBlocks.SMOOTH_RED_NETHER_BRICK_WALL);
